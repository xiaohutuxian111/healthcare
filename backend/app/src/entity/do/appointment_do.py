...
class Appointment(Base, BaseMixin):
    ...
    schedule_start_time: Mapped[datetime.datetime] = mapped_column(DateTime, comment='预约时间')
    schedule_end_time: Mapped[datetime.datetime] = mapped_column(DateTime, comment='预约时间')
